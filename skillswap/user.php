    ...
    <style>
        ...
        * {
        ...
        .skills-carousel {
            ...
            border-radius: 10px;
            overflow: hidden; /*  Чтобы скрыть лишние элементы */
        }
        ...
        .carousel-item {
            padding: 0 15px;
            display: none; /* Изначально скрываем все элементы, кроме первого */
        }

        .carousel-item.active {
            display: block; /* Отображаем активный элемент */
        }
...
<body>
    ...
    <div class="container">
                    ...
                    <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>">
                        <div class="skill-card">
                            ...
                            <form action="actions/add_skill_from_user.php" method="post" class="add-skill-btn">
                                ...
                                <input type="hidden" name="from_user_id" value="<?php echo $skill['user_id']; ?>">
        ...
        <div class="added-skills">
            ...
            <div class="added-skill-item">
                ...
                <?php if (isset($skill['added_from_user_id']) && $skill['added_from_user_id'] !== null): ?>
                <?php
    ...
    $(document).ready(function() {
        ...
        // Обработчики для стрелок управления
        $('.carousel-control-prev').click(function(e) {
            e.preventDefault();
            var current = $('.carousel-inner .carousel-item.active');
            current.removeClass('active');
            var prev = current.prev('.carousel-item');
            if (prev.length) {
        ...
        $('.carousel-control-next').click(function(e) {
            ...
            var current = $('.carousel-inner .carousel-item.active');
            current.removeClass('active');
            var next = current.next('.carousel-item');
            if (next.length) {
